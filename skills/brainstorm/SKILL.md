...
Design approval comes from the user, not from you. Once approved, offer /tally:plan. If `.claude/dev-loop.md` doesn't exist in this repo, also offer /tally:setup once — one line, not a pitch.
